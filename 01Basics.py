...
# === Variables === # 
"""
Variables - are containers for data. The first character of your variable name cannot be a digit.
Variables are equivalent to a certain value, which can be a string or a number. There are used to save values into
memory using a name that we assign.
